    ...
    try:
        ...
        if subtitles:
            ...
            for sub in subtitles:
                if is_portrait:
                    txt_clip = TextClip(sub['text'], fontsize=28, color='#f1f1f1',
                    ...
                    txt_clip = TextClip(sub['text'], fontsize=32, color='#f1f1f1',
                                        font=get_font_path('NotoSansSC-Regular.ttf'),
                                        )
        ...
        main_video = main_video.set_duration(final_duration + 0.5)
